...
<div class="actions">
	<ul>
<?php
	echo "\t\t<li><?php echo \$this->Html->link(__('Edit {$singularHumanName}', true), array('action' => 'edit', {$idKeyPK})); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Delete {$singularHumanName}', true), array('action' => 'delete', {$idKeyPK})); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('List {$pluralHumanName}', true), array('action' => 'index'{$additionalParams})); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('New {$singularHumanName}', true), array('action' => 'add'{$additionalParams})); ?> </li>\n";
