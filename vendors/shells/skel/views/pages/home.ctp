...
<ul>
	...
	<li><a href="http://cakepackages.com"><?php __('CakePackages.com'); ?> </a>
	<ul><li><?php __('Plugin Repository'); ?></li></ul></li>
	<li><a href="http://planetcakephp.org"><?php __('Planet CakePHP'); ?> </a>
	<ul><li><?php __('CakePHP Blog Feed Aggregator'); ?></li></ul></li>
	...
	<li><a href="http://tv.cakephp.org"><?php __('Screencasts'); ?> </a>
	<ul><li><?php __('A collection of instrucitonal and informative screencasts for CakePHP.'); ?></li></ul></li>
