...
<ul>
	...
	<li>
		<h5>This skel is Html5 based upon <?php echo $this->Html->link('Html5Boilerplate', 'http://html5boilerplate.com'); ?> by Paul Irish &amp; Divya (INSERTSURNAME) (and many others); Paul &amp; Divya are working <?php echo $this->Html->link('Html5 Please', 'http://html5please.github.com'); ?></h5>
	</li>
</ul>
